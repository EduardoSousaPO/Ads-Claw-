...
import { TelegramHandler } from '../io/TelegramHandler';
import { CreativeLab } from '../services/CreativeLab';

export class Orchestrator {
    private tg: TelegramHandler;
    private lab: CreativeLab;

    constructor(tgHandler: TelegramHandler) {
        this.tg = tgHandler;
        this.lab = new CreativeLab();
    }
    ...
    private async handleFatigueWarning(clientId: string, clientName: string, cpa: number) {
