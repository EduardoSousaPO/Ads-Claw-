...
| EC-02: Banco de dados bloqueado | Dois loops simultâneos tentam escrita intensa | Espera via timeout natural do driver WAL, senão descarta soft e avisa LLM. |
